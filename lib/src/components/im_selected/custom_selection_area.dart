...
import 'custom_selectable_region.dart' as csr;
...
/// [CustomSelectionArea].
///
/// The [CustomSelectionArea] widget must have a [Localizations] ancestor that
...
class CustomSelectionArea extends StatefulWidget {
  ...
  final csr.SelectableRegionContextMenuBuilder? contextMenuBuilder;
...
class _CustomSelectionAreaState extends State<CustomSelectionArea> {
  ...
  Widget build(BuildContext context) {
    ...
    return csr.CustomSelectableRegion(
